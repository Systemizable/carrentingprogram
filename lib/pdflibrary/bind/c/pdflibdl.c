...
/* $Id: pdflibdl.c,v 1.20 2010/09/07 13:18:32 stm Exp $
 *
...
#elif defined(__linux__) || defined(linux) || defined(sun) || defined(_AIX)
        ...
        reallocproc_t reallocproc, freeproc_t freeproc, PDF **pp)
{
    ...
    get_api = (const PDFlib_api *(PDFLIB_CALL *)(void))
                pdfdl_dlsym(handle, "PDF_get_api");
